if(F){
  browseURL("https://github.com/wilkelab/ggridges/blob/master/R/stats.R") ## Source for this doc 
  browseURL("https://cran.r-project.org/web/packages/ggplot2/vignettes/extending-ggplot2.html") ## Their scaffolding,
  ## Search for 'stat_density_common'
}
